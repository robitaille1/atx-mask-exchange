  ...
  <>
    ...
    <CdcInfo>
      ...
      <div style={{ fontSize: `20px`, margin: "0px" }}>
        <p>
          ...
          healthcare facilities (which is great). Our goal is to get face masks
          into the hands of the general public as quickly as possible.
        </p>
      </div>
    </CdcInfo>
    ...
    <Where>
      <Content style={{ marginTop: "20px" }}>
        ...
        <p>
          We are keeping a running list of all the mask creators in the Austin,
          Texas area. To request a mask, fill out the form on the directory
          page. The wonderful volunteers try to prioritize based on need and the
          date the request was received. One of the mask makers will reach out
    ...
    <ReachOut>
      <div style={{ margin: "0px auto" }}>
        <h3>Reach out</h3>
        <p>
          If you would like masks for you or your family, please go to the Mask
          Directory page to contact a maker directly. If you would like to be
          added to the directory, have materials to contribute, or have any
          other questions - get in touch! We will get back to you as soon as we
          can.
        </p>
